...
#input title
sepal_length=st.number_input('Sepal Length (cm)',min_values=0.0,max_values=10.0,values=5.0,step=0.1)
sepal_width=st.number_input('Sepal width (cm)',min_values=0.0,max_values=10.0,values=3.0,step=0.1)
petal_length=st.number_input('Petal Length (cm)',min_values=0.0,max_values=8.0,values=4.0,step=0.1)
